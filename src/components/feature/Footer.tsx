...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-teal-600 via-emerald-600 to-teal-700 text-white py-8 md:py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-6 md:mb-8">
          ...
          <div>
            <Link to="/home" className="flex items-center gap-3 mb-4 hover:opacity-80 transition-opacity">
              ...
              <h3 className="text-base md:text-lg font-semibold">Career Assistant</h3>
            </Link>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.to}>
                  <Link
                    to={link.to}
                    className="text-xs sm:text-sm text-teal-100 hover:text-white transition-colors inline-flex items-center gap-1 cursor-pointer"
                  >
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-teal-100">
        ...
        {/* Bottom Bar */}
        <div className="pt-6 md:pt-8 border-t border-white/20 flex flex-col sm:flex-row justify-between items-center gap-3 md:gap-4 text-xs sm:text-sm text-teal-100">
          <p>© 2024 Career Assistant. All rights reserved.</p>
          <p className="text-teal-100">NDPR Aligned</p>
        </div>
      </div>
    </footer>
  );
